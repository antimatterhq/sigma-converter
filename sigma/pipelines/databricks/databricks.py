...
def databricks_sigma_example():      # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="databricks example pipeline",
        ...
        items=[
            ProcessingItem(     # This is an example for processing items generated from the mapping above.
                identifier=f"databricks_sigma_windows_{service}",
            ...
            ProcessingItem(     # Field mappings
                identifier="databricks_sigma_field_mapping",
